...
Source0  : https://files.pythonhosted.org/packages/5f/39/27605e133e7f4bb0c8e48c9a6b87101515e3446003e0442761f6a02ac35e/argcomplete-3.5.1.tar.gz
...
%prep
%setup -q -n argcomplete-3.5.1
cd %{_builddir}/argcomplete-3.5.1
pushd ..
cp -a argcomplete-3.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728408522
