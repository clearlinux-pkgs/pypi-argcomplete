...
Source0  : https://files.pythonhosted.org/packages/b8/a0/524e0aaabf9bc3dfcfb4da4c61a0469d5cbac31e39dd807a832ea6098c91/argcomplete-3.2.1.tar.gz
...
%prep
%setup -q -n argcomplete-3.2.1
cd %{_builddir}/argcomplete-3.2.1
pushd ..
cp -a argcomplete-3.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702271425
