...
Source0  : https://files.pythonhosted.org/packages/6d/da/c47f62d2695a2ae9dbc5cd5ef141933f830f512002f8c9bf7527eb3fedd8/argcomplete-3.0.2.tar.gz
...
%prep
%setup -q -n argcomplete-3.0.2
cd %{_builddir}/argcomplete-3.0.2
pushd ..
cp -a argcomplete-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679325467
