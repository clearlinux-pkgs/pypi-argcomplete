...
Source0  : https://files.pythonhosted.org/packages/db/ca/45176b8362eb06b68f946c2bf1184b92fc98d739a3f8c790999a257db91f/argcomplete-3.4.0.tar.gz
...
%prep
%setup -q -n argcomplete-3.4.0
cd %{_builddir}/argcomplete-3.4.0
pushd ..
cp -a argcomplete-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718603411
