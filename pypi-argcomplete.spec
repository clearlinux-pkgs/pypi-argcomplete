...
Source0  : https://files.pythonhosted.org/packages/79/51/fd6e293a64ab6f8ce1243cf3273ded7c51cbc33ef552dce3582b6a15d587/argcomplete-3.3.0.tar.gz
...
%prep
%setup -q -n argcomplete-3.3.0
cd %{_builddir}/argcomplete-3.3.0
pushd ..
cp -a argcomplete-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713191554
