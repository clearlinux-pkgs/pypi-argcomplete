...
Source0  : https://files.pythonhosted.org/packages/f0/a2/ce706abe166457d5ef68fac3ffa6cf0f93580755b7d5f883c456e94fab7b/argcomplete-3.2.2.tar.gz
...
%prep
%setup -q -n argcomplete-3.2.2
cd %{_builddir}/argcomplete-3.2.2
pushd ..
cp -a argcomplete-3.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706111155
