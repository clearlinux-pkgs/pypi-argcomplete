...
Source0  : https://files.pythonhosted.org/packages/75/33/a3d23a2e9ac78f9eaf1fce7490fee430d43ca7d42c65adabbb36a2b28ff6/argcomplete-3.5.0.tar.gz
...
%prep
%setup -q -n argcomplete-3.5.0
cd %{_builddir}/argcomplete-3.5.0
pushd ..
cp -a argcomplete-3.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722966457
